 ...
 */
@Component(
	property = "frontend.data.set.name=" + CMSSiteInitializerFDSNames.VIEW_CONTENTS_FOLDER,
	service = FDSItemsActions.class
)
public class ViewContentsFolderFDSItemsActions implements FDSItemsActions {

	@Override
	public List<FDSActionDropdownItem> getFDSActionDropdownItems(
		HttpServletRequest httpServletRequest) {

		return _sectionDisplayContextHelper.getContentsFDSActionDropdownItems(
			httpServletRequest);
	}
