...
public class LayoutCustomTagsScreenNavigationEntry
	...
	public String getEntryKey() {
		return LayoutScreenNavigationEntryConstants.ENTRY_KEY_CUSTOM_TAGS;
	}
	...
	public boolean isVisible(User user, Layout layout) {
		try {
			if (!StringUtil.equals(
				...
				LayoutSEOLinkManagerUtil.isOpenGraphEnabled(layout)) {
	...
	private static final Log _log = LogFactoryUtil.getLog(
		LayoutCustomTagsScreenNavigationEntry.class);
