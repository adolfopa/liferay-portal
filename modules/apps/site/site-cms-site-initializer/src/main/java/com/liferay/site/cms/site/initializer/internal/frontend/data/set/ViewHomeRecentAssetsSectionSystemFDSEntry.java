...
public class ViewHomeRecentAssetsSectionSystemFDSEntry
	...
	public String getDescription() {
		return "CMS Home Recent Assets Section";
	}

	@Override
	public String getName() {
		return CMSSiteInitializerFDSNames.HOME_RECENT_ASSETS_SECTION;
	}

	@Override
	public String getPropsTransformer() {
		return "{HomeRecentAssetsFDSPropsTransformer} from " +
	...
	public String getTitle() {
		return "Home Recent Assets Section";
	}
