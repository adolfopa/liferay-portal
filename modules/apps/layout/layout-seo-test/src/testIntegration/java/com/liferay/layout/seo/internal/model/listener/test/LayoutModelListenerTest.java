...
public class LayoutModelListenerTest {
	...
	@Test
	public void testBeforeRemoveLayoutModelListener() throws Exception {
		...
		long layoutSEOEntryId = layoutSEOEntry.getLayoutSEOEntryId();

		_layoutLocalService.deleteLayout(layout);

		Assert.assertNull(
			_layoutSEOEntryLocalService.fetchLayoutSEOEntry(layoutSEOEntryId));
	}
