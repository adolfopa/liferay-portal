		...
		<div class="social-relations" id="<portlet:namespace />socialRelations">
			<aui:field-wrapper>
				...
				for (String socialRelationType : socialRelationTypesArray) {
					leftList.add(new KeyValuePair(socialRelationType, LanguageUtil.get(pageContext, SocialRelationConstants.getTypeLabel(allSocialRelationTypes.get(socialRelationType)))));
				}
				...
				for (String socialRelationType : allSocialRelationTypesTypesSet) {
					if (Arrays.binarySearch(socialRelationTypesArray, socialRelationType) < 0) {
						rightList.add(new KeyValuePair(socialRelationType, LanguageUtil.get(pageContext, SocialRelationConstants.getTypeLabel(allSocialRelationTypes.get(socialRelationType)))));
					}
				}
				%>
