...
/**
 * Provides the local service interface for FriendlyURLLocalization. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FriendlyURLLocalizationLocalServiceUtil
...
public interface FriendlyURLLocalizationLocalService extends BaseLocalService,
	...
	*/
	...
	public FriendlyURLLocalization deleteFriendlyURLLocalization(long groupId,
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FriendlyURLLocalization fetchFriendlyURLLocalization(long groupId,
		long friendlyURLId, java.lang.String languageId);
	...
	*/
	...
	public List<FriendlyURLLocalization> updateFriendlyURLLocalizations(
		long friendlyURLId, Map<Locale, java.lang.String> urlTitleMap)
		throws PortalException;
