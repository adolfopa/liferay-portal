...
### Removed HTML title tag from Themes
- **Date:** 2020-Jan-17
- **JIRA Ticket:** [LPS-107271](https://issues.liferay.com/browse/LPS-107271)

#### What changed?

The definition of the HTML tag `title` has been moved from `portal_normal.ftl`
and `portal_pop_up.ftl` in the Unstyled Liferay Theme to a Dynamic include
defined for `/html/common/themes/top_head.jsp#pre`.

#### Who is affected?

This affects anyone that overrides this behaviour from the Unstyled Theme.

#### How should I update my code?

To override this behaviour, you should include your custom HTML tag `title`
above the top_head_include
...
To unify the head tags generated by the portal.
