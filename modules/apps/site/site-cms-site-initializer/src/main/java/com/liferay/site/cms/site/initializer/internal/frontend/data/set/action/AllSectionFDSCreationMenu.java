...
public class AllSectionFDSCreationMenu
	extends AllSectionSystemFDSEntry implements FDSCreationMenu {

	@Override
	public CreationMenu getCreationMenu(HttpServletRequest httpServletRequest) {
		return super.getCreationMenu(httpServletRequest);
	}
	...
	protected void activate(BundleContext bundleContext) {
		...
		setDepotEntryLocalService(_depotEntryLocalService);
