...
public class DLFileEntryServiceWrapper
	...
	@Override
	public int getFileEntriesCount(long groupId, double ratingGTE)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _dlFileEntryService.getFileEntriesCount(groupId, ratingGTE);
	}
