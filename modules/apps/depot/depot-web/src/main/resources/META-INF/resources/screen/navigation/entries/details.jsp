	...
	>
		...
		<aui:fieldset cssClass="default-language ">
			...
			%>
				...
				<aui:input disabled="<%= false %>" label="<%= depotApplication.getLabel(locale) %>" name="TypeSettingsProperties--layoutUpdateable--" type="checkbox" value="<%= depotApplication.isEnabled(group.getGroupId()) %>" />
