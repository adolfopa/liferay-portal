				...
				FDSActionDropdownItemBuilder.setFDSActionDropdownItems(
					FDSActionDropdownItemList.of(
						new FDSActionDropdownItem(
							...
							"pencil", "edit",
							language.get(httpServletRequest, "edit"), "get",
							"update", null),
						new FDSActionDropdownItem(
							HttpComponentsUtil.addParameters(
								portal.getLayoutFullURL(
							...
							language.get(httpServletRequest, "add-subcategory"),
							"get", "update", null),
						new FDSActionDropdownItem(
							HttpComponentsUtil.addParameters(
								portal.getLayoutFullURL(
						...
						new FDSActionDropdownItem(
							...
							language.get(httpServletRequest, "view-usages"),
							"get", null, null))
				).setSeparator(
					true
				).setType(
				...
				FDSActionDropdownItemBuilder.setFDSActionDropdownItems(
					FDSActionDropdownItemList.of(
						new FDSActionDropdownItem(
							...
							language.get(httpServletRequest, "move"), "get",
							"update", null),
						new FDSActionDropdownItem(
