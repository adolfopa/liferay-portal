...
public abstract class BaseCommentResourceImpl implements CommentResource {
	...
	@RequiresScope("everything.read")
	@Override
	public Page<Comment> getDocumentCommentsPage( @PathParam("document-id") Long documentId , @Context Filter filter , @Context Pagination pagination , @Context Sort[] sorts ) throws Exception {
			return Page.of(Collections.emptyList());
