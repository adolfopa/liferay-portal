...
public class SystemVocabularyExceptionMapper
	...
	protected Problem getProblem(
		...
		String languageKey = "system-vocabularies-cannot-be-renamed";

		if (systemVocabularyException instanceof
				SystemVocabularyException.MustNotDeleteSystemVocabulary) {

			languageKey = "system-vocabularies-cannot-be-deleted";
		}

		return new Problem(
			Response.Status.FORBIDDEN,
			_language.get(_acceptLanguage.getPreferredLocale(), languageKey));
	}
