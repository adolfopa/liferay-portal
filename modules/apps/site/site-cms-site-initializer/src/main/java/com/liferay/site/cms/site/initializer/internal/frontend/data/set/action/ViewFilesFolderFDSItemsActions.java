 ...
 */
@Component(
	property = "frontend.data.set.name=" + CMSSiteInitializerFDSNames.VIEW_FILES_FOLDER,
	service = FDSItemsActions.class
)
public class ViewFilesFolderFDSItemsActions implements FDSItemsActions {

	@Override
	public List<FDSActionDropdownItem> getFDSActionDropdownItems(
		HttpServletRequest httpServletRequest) {

		return _sectionDisplayContextHelper.getFilesFDSActionDropdownItems(
			httpServletRequest);
	}
