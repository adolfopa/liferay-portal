...
<div class="container-fluid container-fluid-max-xl pt-4">
	<div class="alert alert-info">
		...
		<%
		String href = "<a href=\"" + HtmlUtil.escape(viewGroupSelectorURL.toString()) + "\">";
		%>

		<strong class="lead">Info:</strong><liferay-ui:message arguments='<%= new Object[] {portletTitle, href, "</a>"} %>' key="x-application-disabled-scope.-please-go-back" />
	</div>
</div>