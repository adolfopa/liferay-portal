...
public class ModularUserLocalServiceWrapper extends UserLocalServiceWrapper {

	public ModularUserLocalServiceWrapper() {
		super(null);
	}

	public ModularUserLocalServiceWrapper(UserLocalService userLocalService) {
