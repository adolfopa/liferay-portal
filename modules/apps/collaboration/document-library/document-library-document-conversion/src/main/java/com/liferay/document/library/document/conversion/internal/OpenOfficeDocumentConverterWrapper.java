...
@Component(
	...
	immediate = true, service = ConverterWrapper.class
)
public class OpenOfficeDocumentConverterWrapper extends BaseConverterWrapper {

	@Override
	public boolean canConvert(String extension) {
		return getConversions(extension).length > 0;
	}

	@Override
	public boolean canConvert(String sourceExtension, String targetExtension) {
		String[] conversions = getConversions(sourceExtension);
	...
	private static final Log _log = LogFactoryUtil.getLog(
		OpenOfficeDocumentConverterWrapper.class);
