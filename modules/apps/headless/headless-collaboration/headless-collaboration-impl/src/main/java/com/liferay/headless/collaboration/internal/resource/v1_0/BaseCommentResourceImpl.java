...
public abstract class BaseCommentResourceImpl implements CommentResource {
	...
	@Override
	public Page<Comment> getBlogPostingCommentsPage( @PathParam("blog-posting-id") Long blogPostingId , @Context Filter filter , @Context Pagination pagination , @Context Sort[] sorts ) throws Exception {
