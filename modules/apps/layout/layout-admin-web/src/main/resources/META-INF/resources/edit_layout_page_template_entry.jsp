...
<soy:component-renderer
	...
	module='<%= layoutsAdminDisplayContext.getResolvedModuleName() + "/js/fragments_editor/FragmentsEditor.es" %>'
...
sb.append(layoutsAdminDisplayContext.getResolvedModuleName());
