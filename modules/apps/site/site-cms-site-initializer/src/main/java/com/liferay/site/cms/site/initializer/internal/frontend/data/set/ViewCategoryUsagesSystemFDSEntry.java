...
public class ViewCategoryUsagesSystemFDSEntry implements SystemFDSEntry {

	@Override
	public String getDescription() {
		return "CMS Category Usages Section";
	}

	@Override
	public String getName() {
		return CMSSiteInitializerFDSNames.CATEGORY_USAGES;
	}

	@Override
	public String getPropsTransformer() {
		return "{CategoryUsagesFDSPropsTransformer} from " +
	...
	public String getTitle() {
		return "Category Usages Section";
	}
